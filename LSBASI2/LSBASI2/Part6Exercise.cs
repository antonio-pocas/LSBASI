...
namespace LSBASI2.Part6Exercise
{
    public class Lexer
    {
    ...
    public class Parser
    {
        ...
        private static readonly HashSet<TokenType> exprTokens = new HashSet<TokenType>() { TokenType.Add, TokenType.Subtract };
        private static readonly HashSet<TokenType> termTokens = new HashSet<TokenType>() { TokenType.Multiply, TokenType.Divide };
        ...
        public int expr()
        {
            ...
            while (exprTokens.Contains(currentToken.Type))
            {
        ...
        private int term()
        {
            ...
            while (termTokens.Contains(currentToken.Type))
            {
